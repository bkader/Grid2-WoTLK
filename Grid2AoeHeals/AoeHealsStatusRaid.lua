...
if AOEM.playerClass ~= "PRIEST" and AOEM.playerClass ~= "DRUID" then
	return
end
...
if AOEM.playerClass == "PRIEST" then
	...
	Grid2:DbSetStatusDefaultValue("aoe-CircleOfHealing", {
...
elseif AOEM.playerClass == "DRUID" then
	...
	Grid2:DbSetStatusDefaultValue("aoe-WildGrowth", {
		type = "aoe-WildGrowth",
		hideOnCooldown = true,
		healthDeficit = 10000,
		minPlayers = 5,
