...
local function MakeDefaultsCommon()
	...
	Grid2:DbSetValue("indicators", "heals", {
		type = "bar",
		parentBar = "health",
		level = 1,
		location = Location("CENTER"),
	...
	Grid2:DbSetValue(
		"indicators",
		"corner-bottom-left",
		{type = "square", level = 5, location = Location("BOTTOMLEFT"), size = 5, color1 = {r = 1, g = 1, b = 1, a = 1}}
	)
	...
	Grid2:DbSetValue(
		"indicators",
		"icon-center",
		{type = "icon", level = 8, location = Location("CENTER"), size = 14, fontSize = 8}
	)
	...
	Grid2:DbSetValue(
		"indicators",
		"icon-right",
		{type = "icon", level = 8, location = Location("RIGHT", 2), size = 12, fontSize = 8}
	)
	Grid2:DbSetValue(
		"indicators",
		"icon-left",
		{type = "icon", level = 8, location = Location("LEFT", -2), size = 12, fontSize = 8}
	)
	...
	Grid2:DbSetValue(
		"indicators",
		"text-up",
		{type = "text", level = 7, location = Location("TOP", 0, -8), textlength = 6, fontSize = 8, font = defaultFont}
	)
	...
	Grid2:DbSetValue("indicators", "text-down", {
		type = "text",
		level = 6,
		location = Location("BOTTOM", 0, 4),
		textlength = 6,
		fontSize = 8,
		font = defaultFont
	})
		...
		MakeDefaultsClass = function()
			...
			Grid2:DbSetValue(
				...
				"buff-EarthShield-mine",
				{
					...
					mine = true,
					colorCount = 2,
					color1 = {r = .9, g = .9, b = .4, a = 1},
					color2 = {r = .9, g = .9, b = .4, a = 1}
				}
			)
			Grid2:DbSetValue(
				"indicators",
				"corner-top-left",
				{type = "square", level = 9, location = Location("TOPLEFT"), size = 5}
			)
			Grid2:DbSetMap("corner-top-left", "buff-Riptide-mine", 99)
			Grid2:DbSetValue(
				"indicators",
				"side-top",
				{type = "square", level = 9, location = Location("TOP"), size = 5}
			)
			Grid2:DbSetMap("side-top", "buff-Earthliving", 89)
			Grid2:DbSetValue(
				"indicators",
				"corner-top-right",
				{type = "square", level = 9, location = Location("TOPRIGHT"), size = 5}
			)
		...
		MakeDefaultsClass = function()
			Grid2:DbSetValue(
				...
				"buff-Lifebloom-mine",
				{
					...
					mine = true,
					colorCount = 3,
					color1 = {r = .2, g = .7, b = .2, a = 1},
					color2 = {r = .6, g = .9, b = .6, a = 1},
			...
			Grid2:DbSetValue(
				"indicators",
				"corner-bottom-right",
				{type = "square", level = 9, location = Location("BOTTOMRIGHT"), size = 5}
			)
	...
	elseif class == "PALADIN" then
		MakeDefaultsClass = function()
			...
			Grid2:DbSetValue(
				"statuses",
				"debuff-Forbearance",
				{type = "debuff", spellName = 25771, color1 = {r = 1, g = 0, b = 0, a = 1}}
			)
			Grid2:DbSetValue(
				"indicators",
				"corner-top-left",
			...
			Grid2:DbSetValue(
				"indicators",
				"corner-bottom-right",
				{type = "icon", level = 8, location = Location("BOTTOMRIGHT"), size = 12, fontSize = 8}
			)
		...
		MakeDefaultsClass = function()
			...
			Grid2:DbSetValue(
				...
				"buff-PrayerOfMending-mine",
				{
					...
					mine = true,
					colorCount = 5,
					color1 = {r = 1, g = .2, b = .2, a = 1},
					color2 = {r = 1, g = 1, b = .4, a = .4},
					color3 = {r = 1, g = .6, b = .6, a = 1},
					color4 = {r = 1, g = .8, b = .8, a = 1},
			...
			Grid2:DbSetValue(
				"statuses",
				"debuff-WeakenedSoul",
				{type = "debuff", spellName = 6788, color1 = {r = 0, g = .2, b = .9, a = 1}}
			)
			Grid2:DbSetValue(
				"indicators",
				"corner-top-left",
			...
			Grid2:DbSetValue(
				"indicators",
				"side-bottom",
				{type = "square", level = 9, location = Location("BOTTOM"), size = 5}
			)
	...
	elseif class == "MONK" then
		MakeDefaultsClass = function()
			...
			Grid2:DbSetValue(
				...
				{type = "buff", spellName = 124682, mine = true, color1 = {r = 0.2, g = 1, b = 0.2, a = 1}}
			)
			Grid2:DbSetValue(
				"statuses",
				"buff-RenewingMist-mine",
				{
					...
					mine = true,
					useSpellId = true,
					color1 = {r = 0.5, g = 1, b = 0, a = 1}
				}
			)
			Grid2:DbSetValue(
				"statuses",
				"buff-LifeCocoon",
				{type = "buff", spellName = 116849, color1 = {r = 0.4, g = 0, b = 0.8, a = 1}}
			)
	...
	elseif class == "MAGE" then
		MakeDefaultsClass = function()
			...
			Grid2:DbSetValue(
				"indicators",
				"corner-bottom-right",
				{type = "square", level = 5, location = Location("BOTTOMRIGHT"), size = 5}
			)
