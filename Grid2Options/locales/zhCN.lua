...
L["Heal filter"] = "治疗过滤"
L["Show incoming heals for the selected heal types."] = "显示承受治疗的治疗类型。"
L["Direct heals"] = "直接治疗"
L["Include direct heals."] = "包括直接治疗。"
L["Channeled heals"] = "通道治疗"
L["Include channeled heals."] = "包括通道治疗"
L["HoT heals"] = "HoT 治疗"
L["Include heal over time effects."] = "包括 HoT 治疗"
