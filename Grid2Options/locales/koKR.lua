...
-- L["Create Buff"] = ""
-- L["Create Default Buffs"] = ""
-- L["Create Default Buffs for %s."] = ""
-- L["Create Debuff"] = ""
-- L["Create Color"] = ""
L["Enabled for"] = "사용 가능"
...
L["Heal filter"] = "치유 필터"
L["Show incoming heals for the selected heal types."] = "치유 받음을 표시할 치유의 타입을 선택합니다."
L["Direct heals"] = "직접 치유"
L["Include direct heals."] = "직접 치유를 표시합니다."
L["Channeled heals"] = "정신 집중 치유"
L["Include channeled heals."] = "정신 집중 치유를 표시합니다."
L["HoT heals"] = "지속 치유"
L["Include heal over time effects."] = "지속 치유 표시합니다."
