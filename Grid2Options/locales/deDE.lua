...
L["buff"] = "Stärkungszauber"
L["debuff"] = "Schwächungszauber"
L["debuffType"] = "Debuff-Typ"

L["New Buff"] = "Neuer Buff"
L["New Debuff"] = "Neuer Debuff"
L["New Color"] = "Neue Farbe"
L["New Status"] = "Neuer Status"
L["Delete Status"] = "Status löschen"
L["Create a new status."] = "Neuen Status erstellen."
L["Create Buff"] = "Buff erstellen"
L["Create Default Buffs"] = "Erstellen Sie Standard-Buffs"
L["Create Default Buffs for %s."] = "Erstelle Standard-Buffs für %s."
L["Create Debuff"] = "Debuff erstellen"
L["Create Color"] = "Farbe erstellen"
L["Enabled for"] = "Aktiviert für"
L["Enable the status only if your character belong to the specified class."] = "Aktivieren Sie den Status nur, wenn Ihr Charakter der angegebenen Klasse angehört."
...
L["health-opacity"] = "Gesundheit Opazität"
...
L["Heal filter"] = "Heilungsfilter"
L["Show incoming heals for the selected heal types."] = "Zeigt eingehende Heilungen für die ausgewählten Heilungstypen."
L["Direct heals"] = "Direkte Heilungen"
L["Include direct heals."] = "Direkte Heilungen einbeziehen."
L["Channeled heals"] = "Kanalisierte Heilungen"
L["Include channeled heals."] = "Kanalisierte Heilungen einbeziehen."
L["HoT heals"] = "HoT Heilungen"
L["Include heal over time effects."] = "HoT (Heal over Time - Heilung über Zeit) Effekte einbeziehen."
