...
L["Create Default Buffs"] = "Создать баффы по умолчанию"
L["Create Default Buffs for %s."] = "Создать баффы по умолчанию для %s."
...
L["Selected Classes"] = "Выбранные классы"
...
L["Name or SpellId"] = "Название или id заклинания"
L["Select Type"] = "Выберите тип"
L["Buff"] = "Бафф"
L["Debuff"] = "Дебафф"
L["Buffs Group"] = "Группа Баффов"
L["Debuffs Group"] = "Группа Дебаффов"
L["Buffs Group: Defensive Cooldowns"] = "Группа Баффов: Защитные заклинания"
